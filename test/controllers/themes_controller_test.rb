...
class ThemesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create theme" do
    assert_difference('Theme.count') do
      post themes_url, params: { theme: { color_code: @theme.color_code, name: @theme.name } }
    end
  ...
  test "should update theme" do
    patch theme_url(@theme), params: { theme: { color_code: @theme.color_code, name: @theme.name } }
